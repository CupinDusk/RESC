...
int main(int argc, char** argv){
  ...
  CUDA_CHECK(cudaMalloc(&d_flags, (size_t)num_clusters * sizeof(int)));
  ...
  CUDA_CHECK(cudaMemset(d_flags, 0, (size_t)num_clusters * sizeof(int)));
