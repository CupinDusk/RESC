...
# 运行所有配置
./cawbresc${RESERVE_ELEMS} 2 1 ${CLUSTER_NUMS} 512 > logtext/resc/${RESERVE_ELEMS}cawb21_${CLUSTER_NUMS}.log
./cawbresc${RESERVE_ELEMS} 4 1 ${CLUSTER_NUMS} 512 > logtext/resc/${RESERVE_ELEMS}cawb41_${CLUSTER_NUMS}.log
./cawbresc${RESERVE_ELEMS} 8 1 ${CLUSTER_NUMS} 512 > logtext/resc/${RESERVE_ELEMS}cawb81_${CLUSTER_NUMS}.log